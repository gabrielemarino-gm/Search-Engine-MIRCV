...
{
    public GabTest(String pathIn)
    {
        // SPIMI legge dei file, elabora e scrive su altri file
        try (FileChannel channel1 = (FileChannel) Files.newByteChannel(Paths.get(pathIn+"/file1.tsv"),
                StandardOpenOption.READ);
             FileChannel channel2 = (FileChannel) Files.newByteChannel(Paths.get(pathIn+"/file2"),
